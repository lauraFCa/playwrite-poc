...
def save_stats_report(results):
    ...
    with open('test_report_stats.md', 'w') as stats_file:
        ...
        stats_file.write(f"Passed Tests: {passed_tests}\n")
        stats_file.write(f"Failed Tests: {failed_tests}\n")
        stats_file.write(f"Skipped Tests: {skipped_tests}\n\n")
        stats_file.write("## Metrics\n\n")
        stats_file.write("Passed: " + str(passed_percentage) + "%\n")
        stats_file.write("Passed in retry: " + str(passed_in_retry) + "%\n")
        stats_file.write("Failed: " + str(failed_percentage) + "%\n")
